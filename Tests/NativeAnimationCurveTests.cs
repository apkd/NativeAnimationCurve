...
public class NativeAnimationCurveTests
{
    ...
    private struct CurveEvaluationJob : IJobParallelFor
    {
        ...
        public NativeAnimationCurve jobAnimationCurve;
    ...
    {
        using (var jac = new NativeAnimationCurve(RandomCurve(10), Allocator.TempJob)) { }
    }
